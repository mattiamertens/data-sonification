...
d3.json("../assets/songs_BER.json").then(data =>{
    trackData = data;
    update(data);
    
    $('.n-of-tracks').text('6/' + data.length + ' TRACKS');
})
...
function update(data){
    ...
    .attr('dataSongLink', d => "../"+d.link+".aac") // cambiare anche il JSON!!!!
    .html(d => 
    ...
    .on('click', function(event, d){
        ...
        if (currentAudio === linkino){
            ...
            if (sound.isPlaying){
                ...
                sound.stop();   
                console.log('clicked another song');
...
//     $('.tooltip-text').toggleClass('visible');
// })
